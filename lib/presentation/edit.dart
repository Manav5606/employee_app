...
class _EditState extends State<Edit> {
  ...
  bool _isInPreviousCollection = false;
  ...
  void initState() {
    ...
    FirebaseFirestore.instance
      ...
      // Initialize the text controllers with the employee details

      nameController.text = (snapshot.data() as Map)['name'];
      dateController.text = (snapshot.data() as Map)['tody'];
      nodateController.text = (snapshot.data() as Map)['nodate'];
      selectedRole = (snapshot.data() as Map)['role'];
      setState(() {
        selectedValue = selectedRole;
        _isInPreviousCollection = true;
      });
    }).catchError((error) {
      FirebaseFirestore.instance
          .collection('current')
        ...
        // Handle error when document not found in users collection
        print("Error: $error");
      });
    });
  }
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      GestureDetector(
                        onTap: () {
                          if (!_isInPreviousCollection) {
                            FirebaseFirestore.instance
                                .collection('current')
                                .doc(widget.documentId)
                                .delete();
                            Fluttertoast.showToast(msg: "Deletes Successfully");
